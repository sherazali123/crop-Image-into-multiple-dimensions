        ...
        if (!is_array($file)) {
            ...
            if ($this->uploaded) {
                $this->file_src_pathname   = $file['tmp_name'];
					...
					//$rand =rand(10,100);
					//$this->file_src_name       = $info[0].'x'.$info[1]."-".$rand.$file['name'];//zohaib
					//$this->file_src_name       = $info[0].'x'.$info[1];//zohaib
					
					//$this->file_peek_name = "-".$rand.$file['name'];
    ...
    function process($server_path = null) {
        ...
        if ($this->processed) {
            //$this->file_dst_path        = $server_path;
				...
				if($this->image_x ==150 && $this->image_y ==150)
					$this->file_dst_path =  "orignal/";
				else
				$this->file_dst_path        = $this->image_x."x".$this->image_y."/";//zohaib
            ...
            $this->file_dst_name = $this->file_dst_name_body . (!empty($this->file_dst_name_ext) ? '.' . $this->file_dst_name_ext : '');
                ...
                if (!$this->file_auto_rename) {
                    ...
                    $this->file_dst_pathname = $this->file_dst_path . $this->file_dst_name;//zoh
                } else {
                    ...
                    while (@file_exists($this->file_dst_pathname)) {
					 ...
					 //  $this->file_dst_name_body = $this->image_x."x".$this->image_y.$this->file_peek_name;//zohaib
					   $this->file_dst_name = $this->file_dst_name_body . (!empty($this->file_dst_name_ext) ? '.' . $this->file_dst_name_ext : '');
					   //$this->file_dst_name = $this->file_dst_name_body ;//zohaib
